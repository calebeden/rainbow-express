...
$dbname = "mission-arlington_attendance";
try {
	$conn_attend = new PDO("mysql:host=$server;dbname=$dbname;", $username, $password);
	//Changing the presentation of errors to exceptions using the setAttribute() method of the PDO object.
	$conn_attend->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	//Changing the default format of returning rows as an associative array
	$conn_attend->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_ASSOC);
